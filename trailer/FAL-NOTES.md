...
| 0b | 0:03 | 00-2-hyperbole | ANIMATE | The hyperbolic claim card: headline lands in two beats ("Command the most powerful" / "office on Earth."), sub fades up. Same quiet intro music. |
| 1 | 0:05.5 | 01-wire-headline | ANIMATE | Type-on with per-key jitter and key-click foley; cursor blink 1.1 s cycle. |
| 2 | 0:06.5 | 20-electoral-map | ANIMATE | States pop in call-order (safe states in bursts, the 7 gold-rimmed swing states one by one, GA last), EV counters run up to 312/226, "270 REACHED" chip lands with a soft gavel tick. |
| 3 | 0:09 | 21-approval | ANIMATE | Approval polyline draws left→right, big 57% odometer-rolls, cohort bars settle staggered, dots drift ±4 px. |
...
| 7 | 0:19 | 06-every-word | ANIMATE | Putin bubble slides in, three replies flick, hostile reply locks with a key-click and gold flare. |
...
| 15 | 0:35.5 | 08-every-consequence | ANIMATE | Third lever flips ON with a heavy clack; all three charts kink at the flip point; wire accelerates. |
...
1. Lock the music: source/mock the marziale, place H1 at 0:13, caesura at
   0:49.5, chords at 0:50.5/0:52.5/0:54.5. Everything conforms to this.
