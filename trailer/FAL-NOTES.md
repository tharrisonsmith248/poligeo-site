...
| 1 | 0:08 | 01-wire-headline | ANIMATE | "Election 2024…" holds; "A Landslide Victory" TYPES IN, letters ALTERNATING red / blue. Comes AFTER the electoral map. |
| 2 | 0:05.5 | 20-electoral-map | ANIMATE | All 51 tiles start GREY; each populates red/blue on the real 2024 call timeline (early safe calls in bursts, then FL/NC/GA, swing states last), and the 312/226 tallies count up as each state fills. Ends 312–226 with the ME-02/NE-02 notches appearing on their calls. |
...
| 7 | 0:19 | 06-every-word | ANIMATE + **FAL** | Signal interface. Bubbles land in order with a Signal-style send tick and pop; the composer sits at the bottom. **FAL: animate the Putin portrait inside the circular avatar** — stylized bust, subtle idle/breathing and a slow blink; no photoreal likeness beyond the game's own stylized depiction. |
...
| 10 | 0:25.5 | 25-invasion-headline | **FAL** | "Dawn on a tropical coastline, several military helicopters flying low over the water toward the beach, US soldiers in silhouette wading ashore from landing craft, kicked-up spray and dust, warm sun low on the horizon, deep navy grade, no faces, no gore." 1.5 s. Composite the BREAKING banner from the frame. |
...
| 23–25 | 0:50.5–0:59 | 17-title → 18-tagline → 19-endslate | ANIMATE | **ONE CONTINUOUS SHOT.** The PG cube (a real 3D cube, map-textured faces) spins in from ~0:50.5 tumbling on chord 1, decelerates and settles upright above the wordmark by 0:52.5 as the tagline fades up (chord 2), then locks dead-square as the end slate assembles beneath it on chord 3 (0:54.5) — date, boxed WISHLIST CTA, links. Hold ≥4 s; cut to black on the final decay. The three frames are keyframes of this single move, not separate cards. |
